...
<form action="actualizarDatos.do">
	<table border=0 style="border:3px solid #04B4AE;">
		...
		<tr><td>First Name: <input type="text" name= "firstname" value="${v.firstName}"/></td></tr>
		<tr><td>Last Name: <input type="text" name= "lastname" value="${v.lastName}"/></td></tr>
		<tr><td>User Name: <input type="text" name= "user" value="${v.userName}"/> <br/></td></tr>
		<tr><td>*Password: <input name= "pwd" type="PASSWORD" /></td></tr>
		<tr><td>*Confirm Password: <input name= "cpwd" type="PASSWORD" /></td></tr>
		<tr><td>Email: <input type="text" name= "email" value="${v.email}"/> </td></tr>
		<tr><td>Phone No: <input type="text" name= "phone" value="${v.phoneNumber}"/></td></tr>
		<tr><td>Address: <input type="text" name= "address" value="${v.address}"/> </td></tr>
